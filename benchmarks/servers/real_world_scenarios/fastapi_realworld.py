#!/usr/bin/env python3
"""
FastAPI Real-World Scenarios Benchmark Server

Complete real-world application scenarios using FastAPI with all common features.
...
def create_fastapi_realworld_server():
    """Create FastAPI server with real-world application scenarios"""

    app = FastAPI(
        title="FastAPI Real-World Scenarios Benchmark",
        description="Complete real-world application scenarios for performance testing",
        version="1.0.0"
    )
    ...
    def get_current_user(user_id: Optional[int] = Header(None, alias="X-User-ID")) -> Optional[User]:
    ...
    async def upload_product_image(
        ...
        background_tasks.add_task(process_product_image, new_filename, content)
...
def main():
    parser = argparse.ArgumentParser(description='FastAPI real-world scenarios benchmark server')
    parser.add_argument('--host', default='127.0.0.1', help='Host to bind to')
    parser.add_argument('--port', type=int, default=8401, help='Port to bind to')
    ...
    print(f"🚀 Starting FastAPI real-world scenarios benchmark server on {args.host}:{args.port}")
